...
```shell
java -Dspring.profiles.active=mysql -jar build/libs/mysql-music-1.0.0.jar
```
...
```sh
cat .tanzu/config/mysql-music.yml
```
...
```shell
tanzu app port-forward mysql-music --port 8080
```
