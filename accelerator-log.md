...
┃ ┃ ┃ ┃ ┃ ╺  Info Will replace [spring-music->mysql-music]
...
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'deploy/tpfork8s/.tanzu/config/spring-music.yml' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.yml, folder=deploy/tpfork8s/.tanzu/config/, filename=spring-music.yml, g0=deploy/tpfork8s/.tanzu/config/spring-music.yml, g1=deploy/tpfork8s/.tanzu/config/, g2=spring-music.yml, g3=spring-music.yml, g4=.yml} and was rewritten to '.tanzu/config/mysql-music.yml'
...
┃ ┃ ┃ ┃ ┃ Debug Adding symbol id with value '33a914'
...
┃ ┃ ┃ ┃ ┗ ┗ ┗ Debug Path 'deploy/tpfork8s/.tanzu/config/spring-music-binding.yml' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.yml, folder=deploy/tpfork8s/.tanzu/config/, filename=spring-music-binding.yml, g0=deploy/tpfork8s/.tanzu/config/spring-music-binding.yml, g1=deploy/tpfork8s/.tanzu/config/, g2=spring-music-binding.yml, g3=spring-music-binding.yml, g4=.yml} and was rewritten to '.tanzu/config/mysql-music-binding.yml'
┃ ┃ ┃ ┃ ┏ engine.transformations[1].validated.transformations[1].otherwise.then.transformations[3] (IfElse)
┃ ┃ ┃ ┃ ┃ engine.transformations[1].validated.transformations[1].otherwise.then.transformations[3].then.apply (Chain)
┃ ┃ ┃ ┃ ┃  Info Running Chain(ReplaceText, RewritePath)
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[1].validated.transformations[1].otherwise.then.transformations[3].then.apply.transformations[0] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [spring-music->mysql-music]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[1].validated.transformations[1].otherwise.then.transformations[3].then.apply.transformations[1] (RewritePath)
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'deploy/tpfork8s/.tanzu/config/spring-music-mysql-instance.yml' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.yml, folder=deploy/tpfork8s/.tanzu/config/, filename=spring-music-mysql-instance.yml, g0=deploy/tpfork8s/.tanzu/config/spring-music-mysql-instance.yml, g1=deploy/tpfork8s/.tanzu/config/, g2=spring-music-mysql-instance.yml, g3=spring-music-mysql-instance.yml, g4=.yml} and was rewritten to '.tanzu/config/mysql-music-mysql-instance.yml'
...
┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music.yml matched [!'deploy/**'] -> included
┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music-binding.yml matched [!'deploy/**'] -> included
┃ ┃ ┃ ┗ ┗ Debug .tanzu/config/mysql-music-mysql-instance.yml matched [!'deploy/**'] -> included
...
┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music.yml matched [!'src/main/java/com/example/music/config/data/**' && !'src/main/java/com/example/music/repositories/mongodb/**' && !'src/main/java/com/example/music/repositories/redis/**'] -> included
┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music-binding.yml matched [!'src/main/java/com/example/music/config/data/**' && !'src/main/java/com/example/music/repositories/mongodb/**' && !'src/main/java/com/example/music/repositories/redis/**'] -> included
┃ ┃ ┃ ┗ Debug .tanzu/config/mysql-music-mysql-instance.yml matched [!'src/main/java/com/example/music/config/data/**' && !'src/main/java/com/example/music/repositories/mongodb/**' && !'src/main/java/com/example/music/repositories/redis/**'] -> included
...
┃ ┃ ┃ ┃ Debug Adding symbol uuid with value 'ecf1cc1d-b44d-4455-b583-c72ab2457847'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music.yml matched ['**'] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music-binding.yml matched ['**'] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music-mysql-instance.yml matched ['**'] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path '.tanzu/config/mysql-music.yml', will use the one appearing last 
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path '.tanzu/config/mysql-music-mysql-instance.yml', will use the one appearing last 
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path '.tanzu/config/mysql-music-binding.yml', will use the one appearing last 
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music.yml didn't match [gradlew*, gradle/**] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music-mysql-instance.yml didn't match [gradlew*, gradle/**] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzu/config/mysql-music-binding.yml didn't match [gradlew*, gradle/**] -> excluded
